        ...
        <div class="row my-4">
                ...
                <div id="accordion">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="card-body">
                                <p style="font-size: .9em;"><b
                                            class="font-weight-sixhundred">Name:</b> {{ ucfirst($template['name']) }}
                                </p>
                                <p style="font-size: .9em;"><b
                                            class="font-weight-sixhundred">Slug:</b> {{ $template['slug'] }}</p>
                                <p style="font-size: .9em;"><b
                                            class="font-weight-sixhundred">Description:</b> {{ $template['description'] }}
                                </p>

                                <p style="font-size: .9em;"><b class="font-weight-sixhundred">Template
                                        View:</b> {{$template['view'] }}</p>

                                <p style="font-size: .9em;"><b class="font-weight-sixhundred">Template
                                        Type:</b> {{ ucfirst($template['template_type']) }}</p>
                                <p style="font-size: .9em;"><b class="font-weight-sixhundred">Template
                                        Name:</b> {{ ucfirst($template['template_view_name']) }}</p>
                                <p style="font-size: .9em;"><b class="font-weight-sixhundred">Template
                                        Skeleton:</b> {{ ucfirst($template['template_skeleton']) }}</p>
                                <p class="text-primary edit-template" style="cursor:pointer;"><i
                                            class="fas fa-trash"></i> Edit Details</p>
                ...
                <div class="card mb-2">
                    <div class="card-header p-3" style="border-bottom:1px solid #e7e7e7e6;">
                        ...
                        <button type="button" class="btn btn-secondary float-right preview-toggle mr-2"><i
                                    class="far fa-eye"></i> Preview
                        </button>
                        <button type="button" class="btn btn-light float-right mr-2 save-draft disabled">Save Draft
                        </button>
                    </div>
                </div>
            ...
            <div class="col-lg-3 d-none d-lg-block">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p style="font-size: .9em;"><b
                                    class="font-weight-sixhundred">Name:</b> {{ ucfirst($template['name']) }}</p>
                        <p style="font-size: .9em;"><b class="font-weight-sixhundred">Slug:</b> {{ $template['slug'] }}
                        </p>
                        <p style="font-size: .9em;"><b
                                    class="font-weight-sixhundred">Description:</b> {{ $template['description'] }}</p>
                        ...
                        <p style="font-size: .9em;"><b class="font-weight-sixhundred">Template
                                Skeleton:</b> {{ ucfirst($template['template_skeleton']) }}</p>
                        <p class="text-primary edit-template" style="cursor:pointer;"><i class="fas fa-trash"></i> Edit
                            Details</p>
                        ...
                        axios.post('{{ route('deleteTemplate') }}', {
                            ...
                            .then(function (response) {
                                ...
                                if (response.data.status == 'ok') {
                                    ...
                                    notie.alert({
                                        type: 1,
                                        text: 'Template Deleted <br><small>Redirecting...</small>',
                                        time: 3
                                    })
